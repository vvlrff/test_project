...
class IntellectualSearch:
   ...
   def elastic_search(self, querry, begin, end):
      query_body = {
  "query": {
    "bool": {
      "must": [
      ...
      for el in result['hits']['hits']:
         elastic_answer.append({'relevant_score': el['_score'], 'id': el['_source']['id'], 'date': el['_source']['date'], 'text': el['_source']['content']})
...
if __name__ == '__main__':
   ...
   search.main('обстрел аэропорта', '2023-10-07', '2023-10-09')
